...
const LEGACY_PRODUCTS: LegacyProduct[] = [
  ...
  { ctId: 'CT-0010', sku: 'MK26269', slug: 'ecu-soft-powerbox-for-pcmflash', categorySlug: 'tuning-tools', titleEn: 'ECU-Soft PowerBox for PCMFlash', descriptionEn: 'Bench power supply designed for PCMFlash ECU programming. Stable power with OBD pinout breakout for direct ECU bench work.', priceMinor: 322960, sortOrder: 10 },
  { ctId: 'CT-0011', sku: 'MKON553', slug: 'xhorse-key-tool-midi-advanced-version-xdkmd0en', categorySlug: 'diagnostic-tools', titleEn: 'Xhorse Key Tool MIDI Advanced Version (XDKMD0EN)', descriptionEn: 'Advanced MIDI key programming device. Supports smart keys, proximity keys and remote generation for a wide range of vehicles.', priceMinor: 322556, sortOrder: 11 },
  { ctId: 'CT-0012', sku: 'MK26449', slug: 'xhorse-key-tool-midi-basic-version-xdkmd0en', categorySlug: 'diagnostic-tools', titleEn: 'Xhorse Key Tool MIDI Basic Version (XDKMD0EN)', descriptionEn: 'Basic MIDI key programming device. OBD and blade key support for mainstream vehicles.', priceMinor: 241816, sortOrder: 12 },
  { ctId: 'CT-0013', sku: 'MKON184', slug: 'avdi-abrites-vehicle-diagnostics-interface', categorySlug: 'diagnostic-tools', titleEn: 'AVDI — Abrites Vehicle Diagnostics Interface', descriptionEn: 'AVDI diagnostics interface for advanced coding, programming and diagnostics on BMW, Mercedes, VAG, Land Rover and more.', priceMinor: 352063, sortOrder: 13 },
  ...
  { ctId: 'CT-0016', sku: 'MK25248', slug: 'genuine-scanmatik-3-professional-scan-and-reprogramming-tool', categorySlug: 'diagnostic-tools', titleEn: 'Genuine Scanmatik 3 Professional Scan and Reprogramming Tool', descriptionEn: 'Scanmatik 3 professional: scanning and reprogramming with OBD diagnostics and ECU data operations.', priceMinor: 174188, sortOrder: 16 },
  { ctId: 'CT-0017', sku: 'MK25353', slug: 'vnci-jlr-doip-jaguar-land-rover-diagnostic-interface', categorySlug: 'diagnostic-tools', titleEn: 'VNCI JLR DoIP Jaguar Land Rover Diagnostic Interface', descriptionEn: 'Genuine VNCI DoIP interface for Jaguar and Land Rover. Full SDD and Pathfinder diagnostics including online programming.', priceMinor: 108595, sortOrder: 17 },
  { ctId: 'CT-0018', sku: 'MKON289', slug: 'godiag-gt100-pro-breakout-box-bmw-cas4-fem-bdc-test-platform', categorySlug: 'diagnostic-tools', titleEn: 'GODIAG GT100 Pro Breakout Box + BMW CAS4 / FEM / BDC Test Platform Bundle', descriptionEn: 'GT100 Pro ECU breakout box with BMW CAS4 and FEM/BDC test platform. Bench testing and programming without the vehicle.', priceMinor: 80336, sortOrder: 18 },
  { ctId: 'CT-0019', sku: 'MK25522', slug: 'gromcalctool-srs-full-package', categorySlug: 'diagnostic-tools', titleEn: 'GromCalcTool SRS Full Package', descriptionEn: 'Complete SRS airbag reset and crash data removal solution. Supports a wide range of vehicle makes with full module coverage.', priceMinor: 413793, sortOrder: 19 },
  { ctId: 'CT-0020', sku: 'MK24017', slug: 'autel-maxiflash-elite-j2534-ecu-programming-device', categorySlug: 'diagnostic-tools', titleEn: 'Autel MaxiFlash Elite J2534 ECU Programming Device', descriptionEn: 'J2534 pass-thru ECU programming device compatible with all OEM dealer software for ECU updates and reprogramming.', priceMinor: 242220, sortOrder: 20 },
  { ctId: 'CT-0021', sku: 'MK19872', slug: 'i-o-io-terminal-multi-tool-device', categorySlug: 'diagnostic-tools', titleEn: 'I/O IO Terminal Multi Tool Device', descriptionEn: 'Multi-function IO Terminal for ECU, TCU and key programming. Supports K-Line, CAN and LIN protocols.', priceMinor: 140891, sortOrder: 21 },
  { ctId: 'CT-0022', sku: 'MK26801', slug: 'probyte-usb-security-dongle', categorySlug: 'diagnostic-tools', titleEn: 'ProBYTE USB Security Dongle', descriptionEn: 'USB security dongle for tuning and diagnostic software license activation.', priceMinor: 60151, sortOrder: 22 },
  { ctId: 'CT-0023', sku: 'MK24914', slug: 'mmcflash-usb-dongle-key', categorySlug: 'diagnostic-tools', titleEn: 'MMCFlash USB Dongle Key', descriptionEn: 'USB dongle for MMCFlash chip tuning platform activation. Enables bench and OBD read/write for supported ECU families.', priceMinor: 52077, sortOrder: 23 },
  { ctId: 'CT-0024', sku: 'MK12384', slug: 'autel-charging-station-back-to-back-pedestal', categorySlug: 'diagnostic-tools', titleEn: 'Autel Charging Station Back-to-Back Pedestal', descriptionEn: 'Dual back-to-back charging pedestal for Autel diagnostic tablets.', priceMinor: 80336, sortOrder: 24 },
  { ctId: 'CT-0025', sku: 'MKON533', slug: 'io-terminal-obd-cable-and-godiag-obd2-jumper-adapter', categorySlug: 'cables-adapters', titleEn: 'IO Terminal OBD Cable and GODIAG OBD2 Jumper Adapter', descriptionEn: 'IO Terminal OBD cable with GODIAG OBD2 jumper adapter for direct ECU bench connection without vehicle power.', priceMinor: 90130, sortOrder: 25 },
  { ctId: 'CT-0026', sku: 'MK20125', slug: 'fortin-flashlink-4-firmware-update-usb-flash-link', categorySlug: 'key-programming', titleEn: 'Fortin Flashlink 4 Firmware Update USB Flash Link', descriptionEn: 'USB flash link for updating Fortin bypass module firmware via bootloader. Required for firmware maintenance.', priceMinor: 18167, sortOrder: 26 },
  { ctId: 'CT-0027', sku: 'MK20064', slug: 'fortin-evo-one-remote-starter-and-security-system-interface', categorySlug: 'key-programming', titleEn: 'Fortin EVO-ONE Remote Starter and Security System Interface', descriptionEn: 'EVO-ONE remote starter and security bypass for a wide range of vehicles. Plug-and-play T-harness compatibility.', priceMinor: 36333, sortOrder: 27 },
  { ctId: 'CT-0028', sku: 'MK20056', slug: 'keydiy-kd-cs01-cloud-key-5-button-universal-garage-remote-22', categorySlug: 'key-programming', titleEn: 'KEYDIY KD CS01 Cloud Key 5-Button Universal Garage Remote 225-915MHz', descriptionEn: 'Universal cloud garage remote. 5 buttons, 225-915MHz adjustable frequency. Compatible with KD Cloud key platform.', priceMinor: 2019, sortOrder: 28 },
  { ctId: 'CT-0029', sku: 'MK15798', slug: 'keydiy-kd-universal-remote-key-4-buttons-garage-type-b31', categorySlug: 'key-programming', titleEn: 'Keydiy KD Universal Remote Key 4 Buttons Garage Type B31', descriptionEn: 'Universal 4-button KD garage remote Type B31 for most KD-based remote cloning systems.', priceMinor: 1413, sortOrder: 29 },
];
...
async function main(): Promise<void> {
  ...
  for (const product of LEGACY_PRODUCTS) {
    try {
      const manufacturer = inferMk3Manufacturer(product.titleEn);
